...
public interface IAcceptTradeOverlay extends IOverlayView {
     ...
     * @param amount   The amount of the resource being received
     */
     ...
     * @param amount   The amount of the resource being given
     */
     ...
     *
     * @param enable Whether or not the accept button is enabled
     */
