...
public interface IDomesticTradeOverlay extends IOverlayView {
     ...
     *
     * @param value Information about the players that can be traded with
     */
     ...
     *
     * @param enable Whether or not player selection is currently allowed
     */
     ...
     *
     * @param resource The resource for which the amount is being set
     * @param amount   The string to be displayed as the resource's amount (can be
     *                 empty)
     */
     ...
     * amount.
     *
     * @param resource    The resource for which amount changing is being enabled or
     *                    disabled
     * @param canIncrease Whether or not the resource's amount may be increased
     * @param canDecrease Whether or not the resource's amount may be decreased
     */
    void
     ...
     *
     * @param enable Whether or not the user can select resources to trade
     */
     ...
     *
     * @param message The new state message
     */
     ...
     *
     * @param enable Whether or not the user may currently execute the trade
     */
