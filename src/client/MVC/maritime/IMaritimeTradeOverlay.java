...
public interface IMaritimeTradeOverlay extends IOverlayView {
     ...
     *
     * @param selectedResource The "get" resource selected by the user
     * @param amount           The amount of the specified "get" resource the user will
     *                         receive (e.g., 1)
     */
     ...
     *
     * @param selectedResource The "give" resource selected by the user
     * @param amount           The amount of the specified "give" resource the user will give
     *                         (e.g., 3)
     */
     ...
     *
     * @param enabledResources Array of "get" resources that should be enabled.
     */
     ...
     * and disabling the ones he can't.
     *
     * @param enabledResources Array of "give" resources that should be enabled.
     */
