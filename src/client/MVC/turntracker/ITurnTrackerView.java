...
public interface ITurnTrackerView extends IView {
     ...
     *
     * @param value The local player's color
     */
     ...
     *
     * @param playerIndex The player's index (0-3)
     * @param points      The number of victory points the player has
     * @param highlight   Whether or not the player's display should be highlighted
     * @param largestArmy Whether or not the player has the largest army
     * @param longestRoad Whether or not the player has the longest road
     */
     ...
     *
     * @param stateMessage The new message to be displayed in the game state button
     * @param enable       Whether or not the game state button should be enabled
     */
