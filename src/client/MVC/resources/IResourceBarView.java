...
public interface IResourceBarView extends IView {
     ...
     *
     * @param element The resource bar element being enabled or disabled
     * @param enabled The new enable/disable state for the specified element
     */
     ...
     *
     * @param element The resource bar element whose amount is being set
